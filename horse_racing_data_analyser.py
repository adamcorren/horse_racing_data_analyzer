    ...
    try:
        while True:
            while True:
                ...
                try:
                    year_pick, month_pick, day_pick = map(int, input('Select date (yyyy, m, d) : ').split(', '))
                    day = datetime(year_pick, month_pick, day_pick)
            ...
            try:
                ...
                print('Hourly data unavailble, try again...')
                continue
